...
clear
	...
	githubrepoKudaraidee=https://github.com/criptopool/yiimp.git
	...
	if [[ ("$DISTRO" == "20") ]]; then
		...
		apt_install recode php7.4-sqlite3 php7.4-tidy php7.4-xmlrpc php7.4-xsl php-imagick php7.4-zip #check
